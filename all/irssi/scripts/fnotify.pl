...
my $EMAIL = "alexander.alemayhu\@googlemail.com";
...
sub filewrite {
	...
	print FILE $date . $text . "\n\n";
        close (FILE);
	my $mail=`echo "Subject: Your username was mentioned in one or more conversations."|cat - $ENV{HOME}/.irssi/fnotify|$SSMTP $EMAIL`;
}
